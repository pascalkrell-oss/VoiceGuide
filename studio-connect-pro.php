...
function scp_callback_request_handler(): void
{
    ...
    if ($count >= 3) {
        wp_send_json_error(['message' => 'Zu viele Anfragen. Bitte später erneut versuchen.'], 429);
    }
    ...
    if (!$sent) {
        wp_send_json_error(['message' => 'Rückrufwunsch konnte nicht gesendet werden. Bitte später erneut versuchen.'], 500);
    }
...
function scp_render_widget(): void
{
    ...
    <div class="studio-connect-widget" id="sc-widget" aria-live="polite">
        ...
        <button class="studio-connect-launcher" id="sc-launcher" type="button" aria-label="Pascal Krell StudioConnect öffnen">
            ...
            <span class="studio-connect-launcher-label studio-connect-launcher-helptext" aria-hidden="true">Brauchst Du Hilfe?</span>
        </button>
