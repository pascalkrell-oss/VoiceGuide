...
class StudioBot {
    ...
    setupHeaderSearch() {
        ...
        popover.innerHTML = '<input type="search" class="sc-search-popover__input" placeholder="Nach Thema suchen..." aria-label="Stichwortsuche" /><div class="sc-search-popover__hint">z.B. Demos, Preise, Ablauf...</div><div class="sc-search-popover__results"></div>';
